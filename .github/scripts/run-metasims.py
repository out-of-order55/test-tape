        ...
        with prefix('source sourceme-manager.sh --skip-ssh-setup'):
            ...
            def run_w_timeout(workload: str, timeout: str):
                ...
                def run_firesim_cmd(typ, extra_args = ""):
                    ...
                    firesim_opts = f"-c {workload} -a {remote_cy_dir}/soc-generator/sims/firesim-staging/sample_config_hwdb.yaml -r {remote_cy_dir}/soc-generator/sims/firesim-staging/sample_config_build_recipes.yaml"
            ...
            run_w_timeout(f"{remote_cy_dir}/soc-generator/sims/firesim-staging/ci/hello-world-localhost-vcs-metasim.yaml", "45m")
            run_w_timeout(f"{remote_cy_dir}/soc-generator/sims/firesim-staging/ci/hello-world-localhost-verilator-metasim.yaml", "45m")
