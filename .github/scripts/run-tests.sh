...
case $1 in
    ...
    chipyard-dmirocket)
        ...
        # $LOCAL_CHIPYARD_DIR/dependencies/scripts/generate-ckpt.sh -b $RISCV/riscv64-unknown-elf/share/riscv-tests/benchmarks/dhrystone.riscv -i 10000
    ...
    chipyard-prefetchers)
        ...
        ;;
    chipyard-gemmini)
        GEMMINI_SOFTWARE_DIR=$LOCAL_CHIPYARD_DIR/soc-generator/generator/gemmini/software/gemmini-rocc-tests
        ...
        ;;
    chipyard-mempress)
        (cd $LOCAL_CHIPYARD_DIR/soc-generator/generator/mempress/software/src && make)
        run_binary BINARY=$LOCAL_CHIPYARD_DIR/soc-generator/generator/mempress/software/src/mempress-rocc.riscv LOADMEM=1
        ;;
    chipyard-compressacc)
        (cd $LOCAL_CHIPYARD_DIR/soc-generator/generator/compress-acc/software-zstd/compress && ./build-hcb-single-file.sh)
        run_binary BINARY=$LOCAL_CHIPYARD_DIR/soc-generator/generator/compress-acc/software-zstd/compress/009987_cl0_ws12.riscv LOADMEM=1
        ;;
    ...
    chipyard-llcchiplet)
        ...
        ;;
    chipyard-rerocc)
        make -C $LOCAL_CHIPYARD_DIR/soc-generator/generator/rerocc/software
        run_binary BINARY=$LOCAL_CHIPYARD_DIR/soc-generator/generator/rerocc/software/test.riscv LOADMEM=1
        ;;
    ...
    chipyard-tacit-rocket)
        ...
        ;;
    chipyard-zephyr)
        run_binary LOADMEM=1 BINARY=$LOCAL_CHIPYARD_DIR/applications/zephyrproject/zephyr/build/zephyr/zephyr.elf
        ;;
    chipyard-radiance)
