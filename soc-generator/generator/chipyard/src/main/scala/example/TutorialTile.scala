...
class MyTileModuleImp(outer: MyTile) extends BaseTileModuleImp(outer){
  ...
  outer.memAXI4Node.out foreach { case (out, edgeOut) =>
    ...
    // The type of "out" here is AXI4Bundle, which is defined in soc-generator/generator/rocket-chip/src/main/scala/amba/axi4/Bundles.scala
    // Please refer to this file for the definition of the ports.
    // If you are using APB, check APBBundle in soc-generator/generator/rocket-chip/src/main/scala/amba/apb/Bundles.scala
    // If you are using AHB, check AHBSlaveBundle or AHBMasterBundle in soc-generator/generator/rocket-chip/src/main/scala/amba/ahb/Bundles.scala
    // (choose one depends on the type of AHB node you create)
    // If you are using AXIS, check AXISBundle and AXISBundleBits in soc-generator/generator/rocket-chip/src/main/scala/amba/axis/Bundles.scala
  }
