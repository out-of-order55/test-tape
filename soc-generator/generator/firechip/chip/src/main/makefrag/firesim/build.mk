...
CHIPYARD_STAGING_DIR := $(chipyard_dir)/soc-generator/sims/firesim-staging

# target scala directories to copy into midas. used by TARGET_COPY_TO_MIDAS_SCALA_DIRS
TARGET_COPY_TO_MIDAS_SCALA_DIRS := \
	$(addprefix $(chipyard_dir)/soc-generator/generator/firechip/,bridgeinterfaces goldengateimplementations)
...
EXTRA_VERILATOR_FLAGS = $(DEFAULT_MIDAS_VERILATOR_FLAGS)
