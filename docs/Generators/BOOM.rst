...
Additional information about the BOOM micro-architecture can be found in the `BOOM documentation pages <https://docs.boom-core.org/>`__. A set of example BOOM Core configurations can be found at `soc-gen/generator/chipyard/src/main/scala/config/BoomConfigs.scala <https://github.com/ucb-bar/chipyard/blob/main/soc-gen/generator/chipyard/src/main/scala/config/BoomConfigs.scala>`__.