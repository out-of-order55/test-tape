...
Example Ara configurations are provided by the Ara repository and compiled directly from ``soc-gen/generator/ara/chipyard/`` when the Ara submodule is initialized.
