...
* C program of the GCD algorithm: :gh-file-ref:`soc-gen/generator/chipyard/src/main/resources/hls/HLSAccel.cpp`

* TCL script to run Vitis HLS: :gh-file-ref:`soc-gen/generator/chipyard/src/main/resources/hls/run_hls.tcl`

* Makefile to run HLS and move verilog files: :gh-file-ref:`soc-gen/generator/chipyard/src/main/resources/hls/Makefile`
...
:gh-file-ref:`soc-gen/generator/chipyard/src/main/scala/example/GCD.scala`.
...
We use Scala to run ``make``, which runs HLS and copies the files into :gh-file-ref:`soc-gen/generator/chipyard/src/main/resources/vsrc`.
