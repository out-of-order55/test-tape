...
Look at the examples in `soc-gen/generator/rocket-chip/src/main/scala/tile/LazyRoCC.scala <https://ucb.bar/rocket-chip/src/main/scala/tile/LazyRoCC.scala>`_ for detailed information on the different IOs.
...
In your ``LazyRoCCModuleImp``, the signal ``io.mem`` is a ``HellaCacheIO``, which is defined in `soc-gen/generator/rocket-chip/src/main/scala/rocket/HellaCache.scala <https://ucb.bar/rocket-chip/src/main/scala/rocket/HellaCache.scala>`_.
