...
To extend this design, you can create your own Chipyard configuration and add the ``WithVCU118Tweaks`` located in `dep/fpga/src/main/scala/vcu118/Configs.scala <https://ucb.bar/chipyard/dep/fpga/src/main/scala/vcu118/Configs.scala>`__.
...
.. literalinclude:: ../../dep/fpga/src/main/scala/vcu118/Configs.scala
    :language: scala
...
The ``VCU118TestHarness`` (located in `dep/fpga/src/main/scala/vcu118/TestHarness.scala <https://ucb.bar/chipyard/dep/fpga/src/main/scala/vcu118/TestHarness.scala>`__) uses ``Overlays`` that connect to the VCU118 external IOs.
...
.. literalinclude:: ../../dep/fpga/src/main/scala/vcu118/TestHarness.scala
    :language: scala
...
This is done with harness binders (see `dep/fpga/src/main/scala/vcu118/HarnessBinders.scala <https://ucb.bar/chipyard/dep/fpga/src/main/scala/vcu118/HarnessBinders.scala>`__).
