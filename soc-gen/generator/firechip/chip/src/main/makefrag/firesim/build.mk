...
CHIPYARD_STAGING_DIR := $(chipyard_dir)/soc-gen/sims/firesim-staging

# target scala directories to copy into midas. used by TARGET_COPY_TO_MIDAS_SCALA_DIRS
TARGET_COPY_TO_MIDAS_SCALA_DIRS := \
	$(addprefix $(chipyard_dir)/soc-gen/generator/firechip/,bridgeinterfaces goldengateimplementations)
