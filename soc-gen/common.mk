...
TAPEOUT_SOURCE_DIRS = $(deps_dir)/tools/tapeout
...
$(UNIQUIFY_STAMP): $(MFC_MODEL_HRCHY_JSON) $(MFC_TOP_HRCHY_JSON) $(MFC_FILELIST) $(MFC_BB_MODS_FILELIST)
	$(deps_dir)/scripts/uniquify-module-names.py \
...
$(SPLIT_MEMS_STAMP): $(MFC_SMEMS_CONF) $(MFC_MODEL_HRCHY_JSON_UNIQUIFIED)
	$(deps_dir)/scripts/split-mems-conf.py \
...
#######################################
dramsim_dir = $(deps_dir)/tools/DRAMSim2
