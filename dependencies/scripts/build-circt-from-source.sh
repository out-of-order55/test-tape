...
(
    cd $RDIR/dependencies/tools/circt
    git submodule init
...
(
    ...
    cd build
    cmake -G Ninja .. \
          -DMLIR_DIR=$RDIR/dependencies/tools/circt/llvm/build/lib/cmake/mlir \
          -DLLVM_DIR=$RDIR/dependencies/tools/circt/llvm/build/lib/cmake/llvm \
          -DLLVM_ENABLE_ASSERTIONS=ON \
          -DCMAKE_BUILD_TYPE=RELEASE \
...
(
    cd $RDIR/dependencies/tools/circt/build
    ninja install
)
