...
SRCDIR="${RDIR}/dependencies/toolchains/riscv-tools"
. "${RDIR}/dependencies/scripts/build-util.sh"

git config --unset submodule.dep/toolchains/riscv-tools/riscv-openocd.update || :
